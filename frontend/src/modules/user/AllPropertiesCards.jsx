  ...
  const getAllProperties = async () => {
    try {
      const res = await axios.get(
        "https://house-rent-backend-r585.onrender.com/api/user/getAllProperties",
      );
...
=======
  const handleBooking = async (status, propertyId, ownerId) => {
    try {
      await axios
        .post(
          `https://house-rent-backend-r585.onrender.com/api/user/bookinghandle/${propertyId}`,
...
>>>>>>> f5cb4bf (Updated backend URL for deployment)
