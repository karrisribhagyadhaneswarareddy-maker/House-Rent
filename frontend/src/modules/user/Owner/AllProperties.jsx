  ...
  const getAllProperty = async () => {
    try {
      const response = await axios.get(
        "https://house-rent-backend-r585.onrender.com/api/owner/getallproperties",
        {
    ...
    if (assure) {
      try {
        const response = await axios.delete(
          `https://house-rent-backend-r585.onrender.com/api/owner/deleteproperty/${propertyId}`,
          {
            headers: {
          ...
          <TableBody>
            {allProperties.map((property) => (
              ...
              >
                ...
                {/* <TableCell align="center"><img style={{width: 150, height: 150}} src={`https://house-rent-backend-r585.onrender.com${property.propertyImage.path}`} alt="photos" /></TableCell> */}
